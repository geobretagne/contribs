...
Ext.onReady(function() {
  ...
  var createTbarItems = function(map) {
        ...
        actions.push(new GeoExt.Action({
            ...
            toggleGroup: "tools",
            allowDepress: false,
            tooltip: "Glisser - d�placer la carte",
  ...
  formSelectedCarte = new GeoExt.form.FormPanel({
    ...
    buttons: [{
      id: 'ddd',
            text: 'Afficher',
      tooltip: 'Visualiser le tms s�lectionn�',
      disabled:true,
      //formBind:true,
      iconCls:'add',
            handler: function(){
  ...
  gridTasks = new Ext.grid.GridPanel({
    ...
    tbar:[{
      ...
      handler: function(){gettasks();},      
            ...
            text:'Kill tasks',
            tooltip:'Kill de tous les tasks (bient�t)',
            iconCls:'remove',
            disabled: true
        }],
        store: storetasks,
  ...
  function submitform() {  
    ...
    if (Ext.getCmp('ccc').getValue() == true)
    {
      ...
      {
        alert("les projection de l�tendue courante et du service s�lectionn� ne sont pas en coh�rence !");
        return;
      }
    }    
